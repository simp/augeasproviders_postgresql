%define mod_name augeasproviders_postgresql

Summary: PostgreSQL Augeas-based providers for Puppet
Name: pupmod-augeasproviders_postgresql
Version: 2.0.1
Release: 0
...
%description
This module provides types/providers for postgresql using the Augeas configuration API library.
